...
% @Last Modified time: 2014-11-14 12:47:42
clear('all');
clc
...
if DO_TRAINING
        ...
        for i=1: length(files)
            ...
            while ischar(tline)
                ...
                for pt =2: size(d{numPt}, 1)-1
                    d_dot(pt -1, 1) = (d{numPt}(pt+1, 1) - d{numPt}(pt-1, 1))/2;
                    d_dot(pt -1, 2) = (d{numPt}(pt+1, 2) - d{numPt}(pt-1, 2))/2;
                end
                d_dot = [d_dot(1, :) ; d_dot];
    ...
    dumpFile = 'hw/hwHMM_s16k320.mat';
    [labels, centroids] = kmeans(trainData(:,1:end-2), numSyms, 'MaxIter',1000);
    trainSeqFiles = {'hw/hw_train_s16k320_c1.hmm.seq', 'hw/hw_train_s16k320_c2.hmm.seq', 'hw/hw_train_s16k320_c3.hmm.seq', 'hw/hw_train_s16k320_c4.hmm.seq', 'hw/hw_train_s16k320_c5.hmm.seq', 'hw/hw_train_s16k320_c6.hmm.seq', 'hw/hw_train_s16k320_c7.hmm.seq', 'hw/hw_train_s16k320_c8.hmm.seq'};
    for i=1:numClasses
    ...
    clear('labels');
    testSeqFiles = {'hw/hw_test_s16k320_c1.hmm.seq', 'hw/hw_test_s16k320_c2.hmm.seq', 'hw/hw_test_s16k320_c3.hmm.seq', 'hw/hw_test_s16k320_c4.hmm.seq', 'hw/hw_test_s16k320_c5.hmm.seq', 'hw/hw_test_s16k320_c6.hmm.seq', 'hw/hw_test_s16k320_c7.hmm.seq', 'hw/hw_test_s16k320_c8.hmm.seq'};
...
MAKE_INIT = false;
initProbabs = {'hw/hw_train_s16k320_c1.hmm', 'hw/hw_train_s16k320_c2.hmm', 'hw/hw_train_s16k320_c3.hmm', 'hw/hw_train_s16k320_c4.hmm', 'hw/hw_train_s16k320_c5.hmm', 'hw/hw_train_s16k320_c6.hmm', 'hw/hw_train_s16k320_c7.hmm', 'hw/hw_train_s16k320_c8.hmm'};
if MAKE_INIT
...
modelFiles = {'hw/hw_train_s16k320_c1.hmm.seq.hmm', 'hw/hw_train_s16k320_c2.hmm.seq.hmm', 'hw/hw_train_s16k320_c3.hmm.seq.hmm', 'hw/hw_train_s16k320_c4.hmm.seq.hmm', 'hw/hw_train_s16k320_c5.hmm.seq.hmm', 'hw/hw_train_s16k320_c6.hmm.seq.hmm', 'hw/hw_train_s16k320_c7.hmm.seq.hmm', 'hw/hw_train_s16k320_c8.hmm.seq.hmm'};
