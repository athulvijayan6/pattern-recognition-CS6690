...
% @Last Modified time: 2014-11-13 19:55:55
clear('all');
clc
...
if DO_TRAINING
    ...
    trainData = zeros(1, 41);
    testData = zeros(1, 41);
    if ~exist('speech/speechDataExtracted.mat')
        ...
        clear('d', 'i', 'j');
        save('speech/speechDataExtracted.mat');
        disp('saving extracted data...');
    else
        load('speech/speechDataExtracted.mat');
        disp('loaded extracted data...')
    end

    dumpFile = 'speech/speechHMM_s5k80.mat';
    numSyms = 80;
    numStates = 5;
    numClasses = max(trainData(:, end-1));
    disp('starting training...');
    [labels, centroids] = kmeans(trainData(:,1:end-2), numSyms, 'MaxIter',1000);
    trainSeqFiles = {'speech/speech_train_s5k80_c1.hmm.seq','speech/speech_train_s5k80_c2.hmm.seq', 'speech/speech_train_s5k80_c3.hmm.seq', 'speech/speech_train_s5k80_c4.hmm.seq', 'speech/speech_train_s5k80_c5.hmm.seq'};
    for i=1:numClasses
    ...
    clear('labels');
    testSeqFiles = {'speech/speech_test_s5k80_c1.hmm.seq','speech/speech_test_s5k80_c2.hmm.seq', 'speech/speech_test_s5k80_c3.hmm.seq', 'speech/speech_test_s5k80_c4.hmm.seq', 'speech/speech_test_s5k80_c5.hmm.seq'};
...
MAKE_INIT = false;
initProbabs = {'speech/speech_train_s5k80_c1.hmm','speech/speech_train_s5k80_c2.hmm', 'speech/speech_train_s5k80_c3.hmm', 'speech/speech_train_s5k80_c4.hmm', 'speech/speech_train_s5k80_c5.hmm'};
if MAKE_INIT
...
modelFiles = {'speech/speech_train_s5k80_c1.hmm.seq.hmm','speech/speech_train_s5k80_c2.hmm.seq.hmm', 'speech/speech_train_s5k80_c3.hmm.seq.hmm', 'speech/speech_train_s5k80_c4.hmm.seq.hmm', 'speech/speech_train_s5k80_c5.hmm.seq.hmm'};
